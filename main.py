...
from utils import detector, predictor
...
def main():
    ...
    cap = cv2.VideoCapture("Tim_Chrys_0.mp4")
    if (cap.isOpened()== False):
        print("Error opening video stream or file")


    landmark_points = getFacelandmarks(img_gray)
    ...
    if (landmark_points is not None):
        ...
        while cap.isOpened():
            ...
            landmark_points2 = getFacelandmarks(img2_gray)
